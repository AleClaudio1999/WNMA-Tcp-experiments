...
NS_LOG_COMPONENT_DEFINE ("TcpMobility");
...
main (int argc, char *argv[])
{
  ...
  sender.Get (0)->GetObject<ConstantVelocityMobilityModel> ()
    ->SetVelocity (Vector (1.0, 0.0, 0.0)); // moving
